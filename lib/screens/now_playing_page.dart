...
import 'package:thennal_music/widgets/now_playing/bottom_actions_row.dart';
import 'package:thennal_music/widgets/now_playing/now_playing_artwork.dart';
import 'package:thennal_music/widgets/now_playing/now_playing_controls.dart';
import 'package:thennal_music/widgets/now_playing/related_songs_section.dart';
import 'package:thennal_music/widgets/queue_list_view.dart';
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  if (metadata.extras?['ytid'] != null &&
                      metadata.extras?['ytid'].isNotEmpty)
                    RelatedSongsSection(
                      songYtId: metadata.extras!['ytid'],
                    ),
                  const SizedBox(height: 16),
                ],
              ),
