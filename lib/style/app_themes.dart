...
import 'package:thennal_music/style/dynamic_color_temp_fix.dart';
...
ThemeData getAppTheme(ColorScheme colorScheme) {
  ...
  return ThemeData(
    ...
    cardTheme: base.cardTheme.copyWith(
      elevation: isLight ? 2 : 0.5,
      shadowColor: isLight ? Colors.black.withOpacity(0.08) : effectiveColorScheme.primary.withOpacity(0.05),
      color: cardBgColor,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(
          color: isLight 
            ? effectiveColorScheme.outlineVariant.withOpacity(0.5)
            : effectiveColorScheme.outline.withOpacity(0.15),
          width: 1,
        ),
      ),
    ...
    inputDecorationTheme: base.inputDecorationTheme.copyWith(
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
          color: effectiveColorScheme.outlineVariant.withOpacity(0.3),
          width: 1,
        ),
      ),
    ...
    dialogTheme: base.dialogTheme.copyWith(
      ...
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(
          color: effectiveColorScheme.outlineVariant.withOpacity(0.2),
          width: 1,
        ),
      ),
    ),
