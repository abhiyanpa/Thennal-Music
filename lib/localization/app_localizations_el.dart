...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get accentChangeMsg => 'Το χρώμα έμφασης έχει αλλάξει';
  ...
  @override
  String get clearSearchHistoryQuestion => 'Καθαρισμός ιστορικού αναζήτησης?';
  ...
  @override
  String get copyLogs => 'Αντιγραφή καταγραφών';

  @override
  String get copyLogsNoLogs => 'Δεν βρέθηκαν καταγραφές για αντιγραφή';
  ...
  String get enableUpdateChecksDescription =>
      'Θα θέλατε το Thennal Music να ελέγχει για ενημερώσεις αυτόματα από τις εκδόσεις του GitHub? Μπορείτε πάντα να ελέγξετε για ενημερώσεις χειροκίνητα από τις ρυθμίσεις';
  ...
  @override
  String get likedPlaylists => 'Λίστες αγαπημένων';
  ...
  @override
  String get restoreUserData => 'Επαναφορά δεδομένων χρήστη';

  @override
  String get restoredSuccess => 'Η επαναφορά ολοκληρώθηκε με επιτυχία';
  ...
  @override
  String get setSleepTimer => 'Ορισμός χρονομέτρου ύπνου';
