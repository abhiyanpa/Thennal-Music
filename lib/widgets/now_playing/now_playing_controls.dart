...
import 'package:thennal_music/widgets/now_playing/marquee_text_widget.dart';
import 'package:thennal_music/widgets/playback_icon_button.dart';
import 'package:thennal_music/widgets/position_slider.dart';
        ...
        return Column(
          ...
          children: [
            ...
            if (!isVeryCompact)
              ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth: isDesktop ? 350 : constraints.maxWidth * 0.85,
                ),
...
class _VolumeSliderState extends State<VolumeSlider> {
  ...
  Future<void> _loadVolume() async {
    final volume = await audioHandler.audioPlayer.volume;
    if (mounted) {
      setState(() {
  ...
  void _setVolume(double volume) {
    ...
    audioHandler.audioPlayer.setVolume(volume);
  }
